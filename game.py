...
# === Налаштування ===
fs = 44100                     # Частота дискретизації для запису звуку (44.1 кГц — стандарт для аудіо)
recording = None              # Змінна, куди буде записуватись сирий аудіопотік
is_recording = False          # Прапорець: чи зараз триває запис
voice_file = "voice_record.wav"   # Файл, куди збережеться записаний голос
